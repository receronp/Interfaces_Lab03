// StateMachine_DateTime_Serial.c : Defines the entry point for the console application.
//
...
int ejecutaEdo(int edo)
{
	...
	case 0:
		...
		mmX = 0;
		aaaaX = 0;
		hhX = hh; // Preparar variables auxiliares por si terminamos en el estado 6, 7, 8 o 9
		nnX = nn;
		ssX = ss;
		break;
	case 1:
	...
	case 10:
		...
		nnX = 0;
		ssX = 0;
		printf(" "); // Imprimir separador entre fecha y horario
		break;
	case 11:
	case 12:
		hhX = (chr - '0');
